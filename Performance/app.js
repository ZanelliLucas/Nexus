...
function initDatePicker() {
  ...
  applyBtn.addEventListener('click', () => {
    ...
    else { const s = new Date(startIn.value), e = new Date(endIn.value); const fmt = d => d.toLocaleDateString('fr-FR',{day:'numeric',month:'short',year:'numeric'}); label.textContent = fmt(s)+' — '+fmt(e); }
